...
{
    public class Enquiry3Controller : BaseController
    {
        ...
        public JsonResult Add(string pincode, string address, string firstOption, string name, string mobileNumber, string email, string pan, string cin, float elit, float donec, float ultrices, float lectus, string companyName)
        {
            ...
            var enquiry3Manager = new Enquiry3Manager();
            var status = enquiry3Manager.Add(pincode, address, firstOption, name, mobileNumber, email, pan, cin, elit, donec, ultrices, lectus, companyName, userId);
