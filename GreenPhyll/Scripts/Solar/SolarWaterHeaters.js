...
solar.AddSolarDetail = function () {
    ...
    solar.ProposedCapacity = $("#solar_capacity").val();
    solar.ShadowFreeArea = $("#solar_shadow_free_area").val();
    ...
    $.ajax({
        ...
        type: "POST",
        url: "/Solar/AddSolarWaterHeaters",
        async: false,
        ...
        success: function (data) {
            ...
            if (status) {
                ...
                window.location.href = "/Offer/Index/Solar Water Heater";
                //alert("Success");
            } else { }
        }
    });
...
solar.AddSolarValidation = function () {
    ...
    $('.next_slide').click(function () {
        ...
        var solar_shadow_free_area_val = $('#solar_shadow_free_area').val();
        ...
        if (current_slide == 3) {
            if ((solar_shadow_free_area_val == '') && (solar_shadow_free_area_val == '') && (solar_capacity_val == '')) {
            ...
            else if (solar_shadow_free_area_val == '' && solar_shadow_free_area_val == '') {
                $('#ebill').show().text('Enter Average Monthly Electricity Bill');
                $('#freeArea').show().text('Enter Shadow free area');
                $('#capacity').hide();
            }
